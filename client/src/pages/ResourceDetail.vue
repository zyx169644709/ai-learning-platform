...
const mockResources: ResourceCard[] = [
  { 
    ...
    type: 'document', 
    preview: '/assets/images/document-cover.svg', 
    downloads: 15420, 
    author: 'AI学院', 
  ...
  { 
    ...
    type: 'code', 
    preview: '/assets/images/code-cover.svg', 
    downloads: 12850, 
    author: '深度学习专家', 
    authorAvatar: '/assets/images/default.png',
  ...
  { 
    ...
    type: 'dataset', 
    preview: '/assets/images/dataset-cover.svg', 
    downloads: 9650, 
    author: '数据科学家', 
    authorAvatar: '/assets/images/default.png',
  ...
  { 
    ...
    type: 'video', 
    preview: '/assets/images/video-cover.svg', 
    downloads: 22300, 
    author: 'Google AI', 
    authorAvatar: '/assets/images/default.png',
  ...
  { 
    ...
    type: 'tool', 
    preview: '/assets/images/tool-cover.svg', 
    downloads: 18700, 
    author: 'Jupyter团队', 
    authorAvatar: '/assets/images/default.png',
